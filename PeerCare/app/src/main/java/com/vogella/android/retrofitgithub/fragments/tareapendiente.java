 ...
 */
public class tareapendiente extends Fragment {
    private ListView lv1;
    private String notificaciones []= {
            "Ayuda para cambiar focos de la casa.",
            "Pasear al perro",
            "Limpiar Garage"};
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_tareapendiente, container, false);
    }
